...
// The AbstractGithub interface specifies the methods provided
// by Github this is useful for mocking instances in tests.
type AbstractGithub interface {
	GithubWebHookConsumer() error
	Ping() error
}
