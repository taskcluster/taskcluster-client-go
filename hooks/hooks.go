...
// The AbstractHooks interface specifies the methods provided
// by Hooks this is useful for mocking instances in tests.
type AbstractHooks interface {
	ListHookGroups() (*HookGroups, error)
	ListHooks(hookGroupId string) (*HookList, error)
	Hook(hookGroupId, hookId string) (*HookDefinition, error)
	GetHookStatus(hookGroupId, hookId string) (*HookStatusResponse, error)
	GetHookSchedule(hookGroupId, hookId string) (*HookScheduleResponse, error)
	CreateHook(hookGroupId, hookId string) (*HookDefinition, error)
	UpdateHook(hookGroupId, hookId string) (*HookDefinition, error)
	RemoveHook(hookGroupId, hookId string) error
}
